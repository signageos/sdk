...
## [2.10.0] - 2026-07-17
### Added
- `applet.version.publish(appletUid, version)`, `.deprecate(appletUid, version)`, and `.renew(appletUid, version)` — set an Applet Version's lifecycle status (publish / deprecate / renew)
...
## [2.4.1] - 2026-03-31
### Fixed
- Firmware version upload hash comparison now handles base64 Content-MD5 from updated API with hex fallback for backward compatibility
...
## [2.1.0] - 2026-01-16
### Added
- `list()` method to `OrganizationTagManagement`
- ContentGuard CRUD related methods
...
## [2.0.3] - 2025-09-23
### Fixed
- Encrypted configuration comparison in timing creation
